...
Rails.application.configure do
  ...
  # Почему-то завешивает нам рельсы и сайдкик
  # config.cache_store = :redis_cache_store, { url: "#{$REDIS_HOST}/1" }

  # TODO: переместить кэш в более правильное место
  # config.cache_store = :file_store, "log/cache"
